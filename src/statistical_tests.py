...
async def t_test(
    ...
    try:
        ...
        result = {
            ...
            "p_value": float(p_value),
            "degrees_of_freedom": len(data1) + (len(data2) if data2 is not None else 0) - (2 if data2 is not None else 1),
...
async def correlation_test(
    ...
    try:
        ...
        if confidence_interval:
            result["confidence_interval_95"] = confidence_interval
